...
export default function Hero() {
  return (
    <BackgroundLines className="relative min-h-screen flex items-center justify-center">
      <div className={`${montserrat.className} px-5 w-full mx-auto max-w-[1000px] flex flex-col gap-6 sm:gap-8 relative z-10 text-center`}>
